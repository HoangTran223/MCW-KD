...
# STU2TEA_ID_MAP="/data/zhangsongming/research/kd4llms/mykd/data/vocab_alignment/qwen_to_gpt2/stu2tea_id_mapping.json"
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/code/distillation_old.py ${OPTS}"
